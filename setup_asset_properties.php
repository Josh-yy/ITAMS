              ...
              <div class="card-body p-3">
                <div class="d-flex align-items-center">
                  <div class="avtar avtar-lg bg-light-success">
                    ...
                    <div class="col">
                         <div class="ms-2">
                          <h4 class="mb-1">Setup Asset Properties<i class="ti ti-arrow-up-right-circle opacity-50"></i></h4>
                          <p class="mb-0 opacity-50 text-sm">Filter and Setup Asset Properties</p>
                        </div>
                    </div>
                   <div class="col-auto">
                      <div class="ms-2">
                         ...
                         <div class="row">
                            ...
                            <div class="card border ">
                              <div class="card-header">
                                   <div class="input-group">
                                      ...
                                      <input type="text" placeholder="Enter Hardware Serial Code" id="txtsearch" class="form-control">
                                      <button class="btn btn-outline-secondary btn-sm" onclick="loadcontent('listviews/v_search_asset_properties','display_hardware_assets',1 + '&search=')" data-bs-toggle="modal" data-bs-target="#mdl_search_list"><i class="ti ti-list"></i></button>
                          ...
                          <div class="row">
                              <div class="col-md-4 col-sm-12">
                                  <div class="card border  dashnum-card dashnum-card-small overflow-hidden">
                                      <div class="card-header text-white bg-dark" >
                                          <b><i class="ti ti-info-circle"></i> Asset Information</b>
                                      </div>
                                      <div class="card-body" id="asset_information">
                              ...
                              <div class="col-md-8 col-sm-12">
                                 <div class="card border dashnum-card dashnum-card-small overflow-hidden">
                                      <div class="card-header text-white bg-dark">
                                          <b><i class="ti ti-info-circle"></i>Asset Properties List</b>
                                      </div>
        ...
        <div class="modal-content">
            <div class="modal-header ">
                ...
                <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="txtsearch" placeholder="Search here..." onkeyup="listrecord('listviews/v_search_asset_properties','display_hardware_assets',1 + '&search=' + $('#txtsearch').val())">
   ...
   function get_display(content){
    var mydata="param=" + content ;
                  $.ajax({type: 'POST',
                    ...
                    cache:false,
                    beforeSend: function (){
                    $("#asset_information").html("<br><br><center><img src='assets/images/load_content.gif' style='width:50%' /></center>");},
                   success: function(data){
                    ...
                    if(data==0){
                      ...
                      //  textToAudio("Hardware Asset verified");
                      $("#asset_information").html(data);
                      listrecord('get_serial_no','txtassetname',content);
                      listrecord('listviews/asset_properties','asset_other_information',content);
                    }
                  }
                  })
   }
