                ...
                <div class="d-flex align-items-center">
                  <div class="row">
                      ...
                      <div class="col-md-10 col-sm-12">
                         <div class="ms-2">
                          <h4 class="mb-1"> <i class="text-success ti ti-credit-card"></i>Hardware Asset Information<i class="ti ti-arrow-up-right-circle opacity-50"></i></h4>
                    ...
                    <div class="card">
                      <div class="card-header with-border bg-secondary text-white">
                        ...
                        <div class="card-body">
                             <div class="form-group">
                                ...
                                <div class="invalid-feedback">
                                     ...
                                     <div class="form-group" style="display:none">
                                         Asset Code : 
                                        <input type="text" class="form-control" name="asset_code" value="<?php echo time() ?>" required>
                                         <div class="valid-feedback">
                            ...
                            <div class="form-group" >
                                         Purchase Order No : 
                                        <input type="text" class="form-control" name="prno" required>
                                         <div class="valid-feedback">
