                ...
                <div class="row">
                     ...
                     <div class="card dashnum-card dashnum-card-small overflow-hidden">
                      ...
                      <ul class="nav nav-tabs profile-tabs border-bottom mb-3 d-print-none" id="myTab" role="tablist">
                        ...
                        <!-- Use ms-auto to push this li to the right -->
                        <li class="nav-item ms-auto" style="border:0px">
                            <a class="nav-link " style="border:0px" id="profile-tab-2" data-bs-toggle="tab" href="#another-tab" role="tab" aria-selected="true">
                               <button class="btn btn-secondary" id="add_subject"  data-bs-toggle="modal" data-bs-target="#addsoftware" onclick="listrecord('../listviews/v_software_list','display_facilities',1 + '&search=');"><i class="ti ti-plus"></i> Add Software</button>
                            </a>
                        </li>
                    </ul>
