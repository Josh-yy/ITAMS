              ...
              <div class="card-body p-3">
                <div class="d-flex align-items-center">
                  <div class="avtar avtar-lg bg-light-success">
                    ...
                    <div class="col">
                         <div class="ms-2">
                          <h4 class="mb-1">Asset Information Viewer<i class="ti ti-arrow-up-right-circle opacity-50"></i></h4>
                          <p class="mb-0 opacity-50 text-sm">View and Set Asset Information</p>
                        </div>
                    </div>
                   <div class="col-auto">
                      <div class="ms-2">
