    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light-secondary bg-light-secondary">
             ...
             <form id="frmadddepartment" class="needs-validation-add" onsubmit="event.preventDefault();submit_form('frmadddepartment','btnsaveselected','../controllers/save_sy','Successfully Saved','../listviews/v_sy','display_list','addnew')" novalidate>
            <div class="modal-body">
                    ...
                    <div class="form-group">
                         School Year:
                        <input type="text" oninput="this.value = this.value.replace(/[^0-9\-]/g, '')" class="form-control" name="name" required>
                         <div class="valid-feedback">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light-secondary bg-sunny-morning">
             ...
             <form id="frmupdatedepartment" class="needs-validation-edit" onsubmit="event.preventDefault();submit_form('frmupdatedepartment','btnupdate','../controllers/update_sy','Successfully Updated','../listviews/v_sy','display_list','mdl_update')" novalidate>
            <div class="modal-body">
                    ...
                    <div class="form-group">
                         School Year:
                        <input type="text" oninput="this.value = this.value.replace(/[^0-9\-]/g, '')" class="form-control" id="name" name="name" required>
                         <div class="valid-feedback">
