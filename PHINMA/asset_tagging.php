              ...
              <div class="card-body p-3">
                <div class="d-flex align-items-center">
                  <div class="avtar avtar-lg bg-light-success">
                    ...
                    <div class="col">
                         <div class="ms-2">
                          <h4 class="mb-1">Asset Tagging<i class="ti ti-arrow-up-right-circle opacity-50"></i></h4>
                          <p class="mb-0 opacity-50 text-sm">Locate and Assign Asset</p>
                        </div>
                    </div>
                   <div class="col-auto">
                      <div class="ms-2">
                         ...
                         <div class="row">
                            ...
                            <div class="card border ">
                              <div class="card-header">
                                   <div class="input-group">
                                      ...
                                      <input type="text" placeholder="Enter search here (Asset Code/Model No./Serial No.)" id="txtsearch" class="form-control">
                                      <button class="btn btn-outline-secondary btn-sm" onclick="loadcontent('listviews/v_hardware_assets_list','display_hardware_assets',1 + '&search=')" data-bs-toggle="modal" data-bs-target="#mdl_search_list"><i class="ti ti-list"></i></button>
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-8 col-sm-12">
                                 <div class="card border dashnum-card dashnum-card-small overflow-hidden">
                                      <div class="card-header text-white bg-dark">
                                          <b><i class="ti ti-info-circle"></i>Asset Details</b>
                                      </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header ">
                ...
                <div class="input-group">
                          <button class="btn btn-secondary"><span class="ti ti-search"></span></button>
                          <input type="text" class="form-control" id="txtsearch" placeholder="Search here..." onkeyup="listrecord('listviews/v_search_users','display_users',1 + '&search=' + $('#txtsearch').val())">
                  ...
                  $.ajax({type: 'POST',
                   ...
                   success: function(data){
                    ...
                    if(data==0){
                      ...
                      listrecord('listviews/asset_track_record','asset_other_information',content);
                    }
                  }
                  })
   }
