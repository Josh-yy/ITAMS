 ...
 <!-- [ Main Content ] start -->
    <div class="pc-container">
      <div class="pc-content">
        <div class="row">
          ...
          <div class="col-auto">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
               ...
               <span class="text-white d-block f-34 f-w-500 my-2"><?php echo get_exist2("select * from  m_software_assets ",$db) ?></span>
              ...
              <div class="card-body">
                ...
                <div class="tab-content" id="chart-tab-tabContent">
                  ...
                  <div class="tab-pane active" id="chart-tab-profile" role="tabpanel" aria-labelledby="chart-tab-profile-tab" tabindex="0">
                    <div class="row">
                      <div class="col-6">
                        <span class="text-white d-block f-34 f-w-500 my-2"><?php echo get_exist2("select a.*, b.typename from m_users a inner join m_usertype b on a.usertype = b.id",$db) ?></span>
        ...
        <li class="nav-item">
              <a class="nav-link" id="expiration-tab" data-bs-toggle="tab" href="#expiration" role="tab" aria-selected="true">
              <div class="media align-items-center">
              <div class="avtar avtar-s">
              <i class="material-icons-two-tone me-2">folder</i>
              </div>
              <div class="media-body ms-3">
               <b>Software Expiration</b>
              <p class="text-sm mb-0">List of Softwares About to Expire</p>
              </div>
              </div>
              </a>
        </li>
        <li class="nav-item">
              <a class="nav-link" id="expiration-tab" data-bs-toggle="tab" href="#recentativities" role="tab" aria-selected="true">
              <div class="media align-items-center">
              <div class="avtar avtar-s">
              ...
              <p class="text-sm mb-0">View Recent Activities</p>
              </div>
              </div>
              </a>
        </li>
        ...
        <div class="tab-content" id="myTabContent">
             ...
             <div class="tab-pane fad " id="recentativities" role="tabpanel" aria-labelledby="home-tab">
                <div class="card border">
                    <div class="card-header"><b><i class="material-icons-two-tone me-2">history</i> Recent Activities</b></div>    
                    <div class="card-body" id="loadactivitys">
                        ...
                        $data = $db->query("SELECT * FROM t_activity_logs order by id desc LIMIT 5")->fetchAll();
           ...
           <div class="tab-pane fade show " id="expiration" role="tabpanel" aria-labelledby="home-tab">
                <div class="card border">
                    <div class="card-header">
                        <b>Softwares that About to Expire</b>
                    </div>
                    <div class="card-body">
                  ...
                  <thead>
                      <tr>
                          ...
                          <th>Remaining Days Before Expiration</th>
                      </tr>
                  </thead>    
                  <tbody>
                      <?php
                      $i=1;
                        $esql = "select * from v_software_expiration";
                      ...
                      ?>
                        <tr>
                            ...
                            <td><?php echo $erow['software_name'] ?></td>
                            <td><span class="badge bg-success"><?php echo $erow['expiration_date'] ?></span></td>
                            <td><span class="badge bg-danger"><?php echo $erow['days_until_expiration'] ?> days</span></td>
                        </tr>
                      <?php
                      $i++;
                        }
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-12">
                <div class="card">
                    <div class="card-header with-border">
                      <b><i class="ti ti-chart-donut"></i>Asset Status</b>
                    </div>
                    <div class="card-body" style="height:300px">
                 ...
                 <div class="card">
                      <div class="card-body">
                        <div class="row mb-3 align-items-center">
                          <div class="col">
                            <h3><i class="ti ti-folders"></i>Department Hardware Assets</h3>
                          </div>
               ...
               <div class="row">
                 <div class="card">
                    ...
                    <div class="card-body">
                      <div class="row">
                          <div class="col-md-12 col-sm-12">
                            <div id="genderdash" style="height:300px; width:100%"></div>
                          </div>
                      </div>
                    </div>
                </div>
...
$yearlabel = [];
//plot the gender dashboard
$gsql = "select * from v_year_purchased_hardware_assets group by eyear";
$gdata = $db->query($gsql)->fetchAll();
foreach($gdata as $grow){
...
foreach($data as $row){
    $arrdept[] = $row['name'];
    $arrcounter[] = get_exist2("select * from t_asset_tagging where department_id = '".$row['id']."' and status = 1",$db);
...
(function () {
     var options = {
          ...
          data: <?php echo json_encode($arrcounter) ?>
        }],
          chart: {
          type: 'bar',
          height: 320
        ...
        xaxis: {
          categories: <?php echo json_encode($arrdept) ?>,
        },
        };
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                          $('#show_more_main'+ID).remove();
                            $('#activitytable tbody').append(data);
                        }
                    });
                });
            });
