...
?>
  <body onload="listrecord('listviews/v_assets','display_list',1 + '&search=')">
    <!-- [ Pre-loader ] start -->
<div class="loader-bg">
              ...
              <div class="card-body p-3">
                <div class="d-flex align-items-center row">
                    ...
                    <div class="col-md-9 col-sm-12">
                         <div class="ms-2">
                          <h4 class="mb-1">Asset Category<i class="ti ti-arrow-up-right-circle opacity-50"></i></h4>
                          <p class="mb-0 opacity-50 text-sm">Manage Asset Category</p>
                        </div>
                    </div>
                   <div class="col-md-3 col-sm-12">
                      <div class="ms-2">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="txtsearch" placeholder="Search here..." onkeyup="listrecord('listviews/v_assets','display_list',1 + '&search=' + $('#txtsearch').val())">
