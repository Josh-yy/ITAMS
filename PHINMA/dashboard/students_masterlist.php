              ...
              <div class="card-body p-3">
                <div class="d-flex align-items-center">
                  <div class="avtar avtar-lg bg-light-success">
                    ...
                    <div class="col-7">
                         <div class="ms-2">
                          <h4 class="mb-1">Students Masterlist<i class="ti ti-arrow-up-right-circle opacity-50"></i></h4>
                          <p class="mb-0 opacity-50 text-sm">Filter, view and download Students information masterlist</p>
                        </div>
                    </div>
                   <div class="col-4">
                      <div class="d-grid">
                        <div class="input-group">
                          ...
                          <button class="btn btn-outline-secondary btn-sm " onclick="listrecord('listviews/student_masterlist','display_list',$('#txtsyfilter').val())"><i class="ti ti-upload"></i>Go</button>
                        </div>
