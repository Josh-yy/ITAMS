...
$uid = get_column2('id',"select * from m_student_information where student_id = '".$_POST['param']."'",$db);
                        ...
                        <div class="col-6">
                              <div class="row">
                                ...
                                <table class="table table-striped table-bordered">
                                  ...
                                  <tbody>
                              <?php
                                  $sql = "select *,date_format(date_published,'%M-%D-%Y %r') as dateadded from t_examination_manager where id = (select exam_id from t_student_mock where student_id = '".$uid."' and sy_id = (select sy_id from m_sy where is_active = 1))";
                              ...
                              ?>
                                  <tr>
                                      ...
                                      <td class="text-center"><?php echo get_column2("total_score","select * from t_mock_subject_group_grade where student_id = '".$uid."' and exam_id = (select exam_id from t_student_mock where sy_id = (select sy_id from m_sy where is_active = 1) and student_id = '".$uid."') and subject_group_id = '".$key."'",$db) ?> </td>
                                      <td class="text-center"><?php echo get_column2("percentage","select * from t_mock_subject_group_grade where student_id = '".$uid."' and exam_id = (select exam_id from t_student_mock where sy_id = (select sy_id from m_sy where is_active = 1) and student_id = '".$uid."') and subject_group_id = '".$key."'",$db) ?> % </td>
                                  </tr>
                              ...
                              <?php
                                  ...
                                  $class = "";
                                  $remarks = get_column2("remarks","select * from t_student_mock where student_id = '".$uid."' and sy_id = (select sy_id from m_sy where is_active = 1)",$db);
                                  if($remarks=="Passed"){
                                    $class = "bg-green-100";
                                  }else{
                                    $class = "bg-red-100";
                              ...
                              <tr class="<?php echo $class ?>">
                                  ...
                                  <td class="text-center"><b><?php echo get_column2("total_percentage","select * from t_student_mock where student_id = '".$uid."' and sy_id = (select sy_id from m_sy where is_active = 1)",$db)  ?> % </b></td>
                              </tr>
                              <tr class="<?php echo $class ?>">
...
$array_modules = [];
$data = $db->query("select * from v_student_subject_group_percentage where student_id = '".$uid."' and sy_id = (select sy_id from m_sy where is_active = 1)")->fetchAll();
foreach($data as $row){
