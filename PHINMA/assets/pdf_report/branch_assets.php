...
$pdf->Cell(25,5,"",0,0,'C');
$pdf->Cell(190,4,'LIST OF HARDWARE ASSETS',0,0,'L');
$pdf->Ln(5);
$pdf->SetFont('Arial','B',13);
$pdf->Cell(25,5,"",0,0,'C');
...
$pdf->Ln(10);
$pdf->SetWidths(Array(10,30,30,30,30,30,20,20,30,25,50));
...
$sql = "select b.* from t_asset_tagging a inner join m_hardware_assets b on a.asset_id = b.id where a.status = 1 and a.branch_id = '".$_REQUEST['cid']."'";
