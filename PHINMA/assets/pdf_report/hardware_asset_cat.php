...
$pdf->Cell(25,5,"",0,0,'C');
$pdf->Cell(190,4,get_column2("name","select * from m_asset_category where id = '".$_REQUEST['cid']."'",$db),0,0,'L');
$pdf->Ln(5);
...
$pdf->Ln(10);
	$pdf->SetWidths(Array(10,40,40,35,35,50,30,30));
$pdf->Row(Array(
					"No",
					"Asset Code",
					"Machine Name",
...
$sql = "select * from m_hardware_assets where asset_cat_id  = '".$_REQUEST['cid']."' order by machine_name ASC";
