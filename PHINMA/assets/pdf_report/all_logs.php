...
$pdf->SetFont('Arial','',8);
// Title
$pdf->Image('../images/arc.png',150,20,40);
$pdf->Ln(4);
...
$pdf->Cell(10,5,'',0,0,'C');
$pdf->CellFitScale(150,5,strtoupper('ARCHIVING SYSTEM'),0,0,'L');
...
$data = $db->query("select * from t_activity_logs where performed_by = '".$_SESSION['data']['account_id']."' order by date_performed desc")->fetchAll();
