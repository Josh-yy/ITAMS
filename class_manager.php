...
?>
  <body onload="listrecord('listviews/v_classes','display_list',1 + '&search=')">
    <!-- [ Pre-loader ] start -->
<div class="loader-bg">
              ...
              <div class="card-body p-3">
                <div class="d-flex align-items-center">
                  <div class="avtar avtar-lg bg-light-success">
                    ...
                    <div class="col">
                         <div class="ms-2">
                          <h4 class="mb-1">Manage Manage Class Information<i class="ti ti-arrow-up-right-circle opacity-50"></i></h4>
                   ...
                   <div class="col-auto">
                      <div class="ms-2">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="txtsearch" placeholder="Search here..." onkeyup="listrecord('listviews/v_curriculum','display_list',1 + '&search=' + $('#txtsearch').val())">
