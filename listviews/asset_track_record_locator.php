...
$sql = "select * from m_hardware_assets where auto_qr_code = '".$db->sanitize($_POST['param'])."' or serial_number = '".$db->sanitize($_POST['param'])."'";
...
<li class="nav-item">
<a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><i class="ti ti-user-plus"></i>Assign Hardware Asset</a>
</li>
<li class="nav-item">
<a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false"><i class="ti ti-history"></i>Tagging History</a>
</li>
...
<div class="card-body">
	...
	<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
	    ...
	    <div><h3> <i class="ti ti-info-circle"></i> <b>Asset already Tagged : </b></h3>
	      <p>
	        The hardware asset with serial # <b><?php echo $serial ?></b> already tagged to the user information below.
	      </p>
	    </div>
	    </div>
	    	...
	    	<div class="card border">
	    			<div class="card-body">
	    				...
	    				<?php
								...
								if(get_column2("avatar","select * from m_users where id = (select asset_holder_id from t_asset_tagging where asset_id = '$hardware_asset_id' and status = 1)",$db)!=""){
