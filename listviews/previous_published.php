...
if(get_exist2("select * from t_examination_manager where is_published=2",$db)>0){
  $esql = "select * ,date_format(date_published,'%Y-%m-%d %r') as dateadded from t_examination_manager where is_published=2 and unpublished=1";
...
<div class="card border follower-card">
  <div class="card-header">
    ...
    <span style="display:none"> class="btn btn-outline-secondary" id="unpublish<?php echo $erow['id'] ?>" onclick="unpublish('<?php echo $erow['id'] ?>')" style="float:right"><i class="ti ti-plus"></i>Unpublish and Set New</span> 
  </div>
  <div class="card-body">
...
<div class="alert alert-warning">
    <h4>Reminder</h4>
    There is no previously published examination yet. Once examination is unpublished it will be redirected here.</b>
</div>  
<?php
}
?>
