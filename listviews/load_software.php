...
<table class="table table-bordered"> 
    ...
    <tbody>
      <?php
      $final_sql = "select *  from m_hardware_assets";
...
<?php
  ...
  $final_sql = "select * from m_software_assets"; 
  $data = $db->query($final_sql)->fetchAll();
...
if($asset_type=="Hardware"){
?>
     <iframe class="embed-responsive-item" id="empid" src="assets/pdf_report/asset_inventory?cid=<?php echo $_POST['param'] ?>" frameborder="0" allowfullscreen></iframe>
<?php
}else{
?>
  <iframe class="embed-responsive-item" id="empid" src="assets/pdf_report/softwareasset?cid=<?php echo $_POST['param'] ?>" frameborder="0" allowfullscreen></iframe>
<?php
}
?>
</div>
