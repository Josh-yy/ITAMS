                    ...
                    <div class="col-md-5 col-sm-12">
                        <div class="card border">
                            <div class="card-header bg-dark text-white">
                              <b class="card-title"><i class="ti ti-list"></i> Hardware Disposal and Asset Expiration Notification Recipients</b>
                              <span class="btn btn-secondary btn-sm float-end" data-bs-target="#mdlrecepients" onclick="listrecord('listviews/v_recepients_list','display_users',1+'&search=')" data-bs-toggle="modal" id="btnclick"><i class="ti ti-search"></i> Add Recipients </span>
                            </div>
                          ...
                          <div class="card border">
                            <div class="card-header bg-dark text-white">
                              <b class="card-title"><i class="ti ti-list"></i>Software Notification Baseline (in days)</b>
      ...
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"><i class="mdi mdi-camera"></i>Select Notification Recipients</h4>
