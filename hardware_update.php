              ...
              <div class="card-body p-3">
                <div class="d-flex align-items-center">
                  <div class="avtar avtar-lg bg-light-success">
                    ...
                    <div class="col">
                         <div class="ms-2">
                          <h4 class="mb-1">Request Hardware Status Update<i class="ti ti-arrow-up-right-circle opacity-50"></i></h4>
                          <p class="mb-0 opacity-50 text-sm">Filter and Request Assets to be Updated.</p>
                        </div>
                    </div>
                   <div class="col-auto">
                      <div class="ms-2">
                            ...
                            <div class="card border ">
                              <div class="card-header">
                                   <div class="input-group">
                                      ...
                                      <button class="btn btn-outline-secondary btn-sm" onclick="loadcontent('listviews/v_hardware_update_list','display_hardware_assets',1 + '&search=' + '&locator=1')" data-bs-toggle="modal" data-bs-target="#mdl_search_list"><i class="ti ti-list"></i></button>
                  ...
                  $.ajax({type: 'POST',
                   ...
                   success: function(data){
                    ...
                    if(data==0){
                      ...
                      listrecord('listviews/asset_update_viewer','asset_other_information',content);
                    }
                  }
                  })
   }
