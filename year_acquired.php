              ...
              <div class="card-body p-3">
                <div class="d-flex align-items-center row">
                    ...
                    <div class="col-md-7 col-sm-12">
                         <div class="ms-2">
                          <h4 class="mb-1">Assets Acquired per Year<i class="ti ti-arrow-up-right-circle opacity-50"></i></h4>
                          <p class="mb-0 opacity-50 text-sm">Sort assets based on their acquisition year.</p>
                        </div>
                    </div>
